...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2049.9029020941803; // y position of the first parallel encoder (in tick units)
        public double par1YTicks =  2531.3368214245716; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3658.059357402283; // x position of the perpendicular encoder (in tick units)
    }
